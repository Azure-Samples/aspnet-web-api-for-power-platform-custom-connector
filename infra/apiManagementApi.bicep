...
resource apimapioperations 'Microsoft.ApiManagement/service/apis/operations/policies@2022-08-01' = [for operation in apiManagement.api.operations: {
  name: '${apimapi.name}/${operation.name}/policy'
  properties: {
    format: operation.policy.format
    value: operation.policy.value
  }
}]
